...
import { useVehicles, useLocations } from '@/lib/hooks/useSupabase'
...
export function LocationOverview() {
  ...
  // Memoized location progress calculations
    ...
    return (
      <div className="card">
        <div className="card-body text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">Location data is being loaded or not yet configured.</p>
          <button
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className={`text-sm ${isSelected ? 'text-primary-100' : 'text-gray-600'}`}>
                        {location.duration}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-white border-opacity-20 animate-fade-in">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-primary-100">Working Days</span>
