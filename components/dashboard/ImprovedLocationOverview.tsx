...
import { useLocationStatsApi } from '@/lib/hooks/useApi'
import { LoadingSpinner } from '../ui/LoadingSpinner'

export default function ImprovedLocationOverview() {
  const { data: locationStats = [], isLoading: loading, error } = useLocationStatsApi()
    ...
    return (
      <div className="card">
        <div className="card-body text-center">
          ...
          <p className="text-sm text-gray-600">Failed to load location data</p>
        </div>
      </div>
    )
  }
